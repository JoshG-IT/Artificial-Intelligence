...
This repository contains structured **AI and automation training materials** including **How-Tos**, **Cheat Sheets**, and **Projects** used for educational and demonstration purposes.  
...
| Folder | Description |
|--------|--------------|
| [`/How-Tos`](./How-Tos) | Guides for prompt engineering, API integration, and AI tool setup. |
| [`/CheatSheets`](./CheatSheets) | Command references and syntax tips for Python, OpenAI, and automation. |
| [`/Projects`](./Projects) | AI-driven student projects focused on automation, chatbots, and ML concepts. |
